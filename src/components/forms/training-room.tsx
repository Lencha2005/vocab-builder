...
//   tasks: TaskWord[]; // tasks уже фільтровані за напрямком
...
// export default React.memo(function TrainingRoom({
//   tasks,
//   onComplete,
//   direction,
//   setDirection,
...
//   useEffect(() => {
//     // при зміні напрямку — скидуємо стан
//     setCurrentIndex(0);
//     setAnswers([]);
//     reset();
//   }, [direction, reset]);
...
//         <button
//           type="button"
//           onClick={() => setDirection(prev => (prev === 'ua' ? 'en' : 'ua'))}
//         >
//           Змінити напрямок: {isUaToEn ? 'UA → EN' : 'EN → UA'}
//         </button>
//       </div>
